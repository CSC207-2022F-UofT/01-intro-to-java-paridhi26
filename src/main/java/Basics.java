...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        //ret.concat(String.valueOf(arrOfStr[0].charAt(0)));
        //ret.concat(String.valueOf(arrOfStr[1].charAt(0)));
        ret.append(arrOfStr[0].charAt(0));
        ret.append(arrOfStr[1].charAt(0));
        ret.append(arrOfStr[2].charAt(0));
        ret.append(arrOfStr[3].charAt(0));
        ret.append(arrOfStr[4].charAt(0));
        ret.append(arrOfStr[5].charAt(0));
        ret.append(arrOfStr[6].charAt(0));
        return ret.toString();
    }
